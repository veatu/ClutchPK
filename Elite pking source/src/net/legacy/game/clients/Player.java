...
public abstract class Player implements Constants {
    ...
    // Devolution: smelting
    public boolean dialog = true, spinning = false;
    public int dialogInterface = 2459, dialogId = 1;
    public String dMsg = "";
    public int doors = -1;
    ...
    public void setAppearanceUpdateRequired(boolean appearanceUpdateRequired1) {
        appearanceUpdateRequired = appearanceUpdateRequired1;
    }
    ...
    public void setHitDiff(int diff) {
        hitDiff = diff;
    }

    public void setHitUpdateRequired(boolean hUpdateRequired) {
        hitUpdateRequired = hUpdateRequired;
    }
    ...
    public void addNewPlayer(Player plr, Stream str, Stream updateBlock) {
        playerInListBitmap[plr.playerId >> 3] |= 1 << (plr.playerId & 7); // set the flag
        playerList[playerListSize++] = plr;

        str.writeBits(11, plr.playerId); // client doesn't seem to like id=0
    ...
    public void appendDirUpdate(Stream str) {
        if (playerMD != -1) {
			 ...
			 * Miscellaneous.xlateDirectionToClient[playerMD]); if (updateRequired) {
...
playerProps.writeByte(hint);
        ...
        playerProps.writeQWord(Miscellaneous.playerNameToInt64(playerName));
    ...
    protected void appendPlayerChatText(Stream str) {
        ...
        if (playerRights == 3) {
            ...
            str.writeByte(7);
        } else if (playerRights != 3 && playerRights != 2 && playerRights != 1) {
    ...
    {
        poisonDmg = true;
        poisonDelay = Miscellaneous.random(60);
        hitDiff = Miscellaneous.random(5);
        updateRequired = true;
    ...
    public void applyRecoil() {
        hitDiff = Miscellaneous.random(2);
    ...
    public int getNextWalkingDirection() {
        ...
        int dir;
        do {
            dir = Miscellaneous.direction(currentX, currentY,
        ...
        if (dir == -1)
            return -1;
        dir >>= 1;
        currentX += Miscellaneous.directionDeltaX[dir];
        currentY += Miscellaneous.directionDeltaY[dir];
        absX += Miscellaneous.directionDeltaX[dir];
        absY += Miscellaneous.directionDeltaY[dir];
        return dir;
    }
    ...
    public void postProcessing() {
        if (newWalkCmdSteps > 0) {
            ...
            int dir = Miscellaneous.direction(currentX, currentY, firstX, firstY);
            if ((dir != -1) && ((dir & 1) != 0)) {
                ...
                do {
                    ...
                    dir = Miscellaneous.direction(walkingQueueX[ptr],
            ...
            if (!found) {
                ...
                if ((dir != -1) && ((dir & 1) != 0)) {
                    ...
                    dir = Miscellaneous.direction(wayPointX1, wayPointY1, wayPointX2,
                            wayPointY2);
                    if ((dir == -1) || ((dir & 1) != 0)) {
                        ...
                        while ((x != wayPointX2) || (y != wayPointY2)) {
                            x += Miscellaneous.directionDeltaX[dir];
                            y += Miscellaneous.directionDeltaY[dir];
                            if ((Miscellaneous.direction(x, y, firstX, firstY) & 1) == 0) {
                                found = true;
                                break;
                            }
                        }
    ...
    public void updatePlayerMovement(Stream str) {
        if (dir1 == -1) {
            ...
            str.writeBits(1, 1);
            str.writeBits(2, 1);
            str.writeBits(3, Miscellaneous.xlateDirectionToClient[dir1]);
            str
                    .writeBits(1,
            ...
            str.writeBits(2, 2);
            str.writeBits(3, Miscellaneous.xlateDirectionToClient[dir1]);
            str.writeBits(3, Miscellaneous.xlateDirectionToClient[dir2]);
            str
                    .writeBits(1,
                            (updateRequired || chatTextUpdateRequired) ? 1 : 0);
        }
